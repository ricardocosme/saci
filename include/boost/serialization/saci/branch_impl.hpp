                      ...
                      boost::mpl::true_)
{
    ...
    boost::fusion::for_each(o.children, save_child_branch_impl<Archive>{ar});
}
...
inline void save_impl(Archive& ar, BranchNode& o, unsigned int version,
                      boost::mpl::false_)
{
    save_child_branch_impl<Archive>{ar}(o.children);
}
...
inline void save(Archive& ar,
                 const saci::tree::branch_impl<
                 T, CheckPolicy, Children, Parent>& o,
                 unsigned int version)
{
    using branch_t = saci::tree::branch_impl<
                      ...
                      boost::mpl::true_)
{
    std::size_t n;
    ar >> n;
    boost::fusion::for_each(o.children, load_child_branch_impl<Archive>{ar});
}
...
inline void load_impl(Archive& ar, BranchNode& o, unsigned int version,
                      boost::mpl::false_)
{
    load_child_branch_impl<Archive>{ar}(o.children);
}
...
template<typename Archive,
         ...
         typename Parent>
inline void serialize(Archive& ar,
                      saci::tree::detail::legacy::branch_impl_base<
                      T, CheckPolicy, Children, Parent>& o,
                      unsigned int version)
{
    ar & static_cast<typename saci::tree::detail::legacy::branch_impl_base<
